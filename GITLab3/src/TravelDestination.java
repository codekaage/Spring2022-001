...
public class TravelDestination {
	...
	public static void main(String[] args) {
        ...
        System.out.println("My name is Logan Hall. I wish to travel to New York one day!"); 
				...
				System.out.println("My name is Erik Sistos. I wish to travel to Italy one day!");
				System.out.println("My name is Varun Prasad. I wish to travel to Japan one day!");
	}
